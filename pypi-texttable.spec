...
Source0  : https://files.pythonhosted.org/packages/1c/dc/0aff23d6036a4d3bf4f1d8c8204c5c79c4437e25e0ae94ffe4bbb55ee3c2/texttable-1.7.0.tar.gz
...
%prep
%setup -q -n texttable-1.7.0
cd %{_builddir}/texttable-1.7.0
pushd ..
cp -a texttable-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720049510
...
cp %{_builddir}/texttable-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-texttable/9462bef0996c5adf3697a1cb5fff34a43f40edaa || :
